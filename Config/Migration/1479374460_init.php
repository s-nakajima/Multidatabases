		...
		'up' => array(
			'create_table' => array(
				'multidatabase_contents' => array(
					...
					'multidatabase_key' => array('type' => 'string', 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'),
				...
				'multidatabase_metadatas' => array(
					...
					'type' => array('type' => 'string', 'null' => false, 'default' => '1', 'length' => 20, 'collate' => 'utf8_general_ci', 'comment' => '属性 0:画像,1:テキスト,2:テキストエリア,3:リンク,4:選択式（択一）,5:ファイル,6:WYSIWYGテキスト,7:自動採番,8:メール,9:日付,10:登録日時,11:更新日時,12:選択式（複数）', 'charset' => 'utf8'),
					...
					'is_title' => array('type' => 'boolean', 'null' => false, 'default' => '0', 'comment' => 'タイトルとするか 0:しない,1:する'),
					...
					'is_visible_file_dl_counter' => array('type' => 'boolean', 'null' => false, 'default' => '0', 'comment' => 'ファイルDL回数を表示するか 0:表示しない,1:表示する'),
					'is_visible_field_name' => array('type' => 'boolean', 'null' => false, 'default' => '0', 'comment' => '項目名を表示するか 0:表示しない,1:表示する'),
