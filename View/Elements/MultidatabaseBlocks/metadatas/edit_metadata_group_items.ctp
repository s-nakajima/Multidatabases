			...
			<div class="pull-left">
				<div class="btn-group" uib-dropdown dropdown-append-to-body>
					...
					<ul class="dropdown-menu" uib-dropdown-menu role="menu">
						...
						<li class="divider"></li>
						<li class="move-item-group-0"><a href="" ng-click="movePosition(0,<?php echo $gPos; ?>,$index)"><span><?php echo __d('multidatabases', 'Go to Section 1'); ?></a></li>
						<li class="move-item-group-1"><a href="" ng-click="movePosition(1,<?php echo $gPos; ?>,$index)"><span><?php echo __d('multidatabases', 'Go to Section 2 (Left)'); ?></span></a></li>
						<li class="move-item-group-2"><a href="" ng-click="movePosition(2,<?php echo $gPos; ?>,$index)"><span><?php echo __d('multidatabases', 'Go to Section 2 (Right)'); ?></span></a></li>
						<li class="move-item-group-3"><a href="" ng-click="movePosition(3,<?php echo $gPos; ?>,$index)"><span><?php echo __d('multidatabases', 'Go to Section 3'); ?></span></a></li>
					</ul>
				</div>
			</div>
