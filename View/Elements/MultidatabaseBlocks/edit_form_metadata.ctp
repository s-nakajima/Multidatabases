<?php foreach ($this->MultidatabaseMetadataSetting->fieldList() as $field): ?>
	<?php $this->Form->unlockField('MultidatabaseMetadata..'. $field); ?>
<?php endforeach; ?>

<div id="multidatabase-metadata-fields" ng-controller="MultidatabaseMetadatas" ng-init="initialize(<?php echo h(json_encode(['multidatabaseMetadatas' => $multidatabaseMetadatas['data']])); ?>)">
